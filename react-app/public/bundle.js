...
var _reactCustomModule = __webpack_require__(27);
...
(0, _reactDom.render)(_jsx(App, {}), document.getElementById('app'));
...
var Button = function Button(_ref) {
    var _ref$label = _ref.label,
        label = _ref$label === undefined ? 'Button label goes here' : _ref$label;

    return _react2.default.createElement('input', { type: 'button', value: label });
};
    ...
    _createClass(Container, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                subHeadline = _props.subHeadline;
